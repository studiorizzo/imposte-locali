...
import { Colors, Sizes, Shadows, Insets } from '../theme';
...
export function ContribuenteFormPanel({ onClose, onSave, onDelete }: ContribuenteFormPanelProps) {
  ...
  return (
    ...
    >
      {/* Header - with top padding matching Flokk: Insets.l * 0.75 = 18px */}
      <div
        className="flex items-center justify-between px-6 border-b border-gray-200"
        style={{ paddingTop: Insets.l * 0.75, paddingBottom: Insets.m }}
      >
        <button
