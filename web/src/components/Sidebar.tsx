    ...
    <aside className="w-64 bg-[#00a086] rounded-tr-[10px] flex flex-col relative">
      ...
      <div className="px-4 pt-6 pb-4">
        <button
          ...
          className="w-full h-[60px] flex items-center gap-2 bg-[#00a086] border-2 border-dashed border-white/60 hover:bg-[#00856f] text-white font-semibold text-sm px-4 rounded-lg transition-colors"
        >
        ...
        <ul className="space-y-1">
          <li className="relative">
            ...
            {currentView === 'dashboard' && (
              <span className="absolute -left-4 top-1/2 -translate-y-1/2 w-[6px] h-[48px] bg-white" />
            )}
            <button
              onClick={() => onNavigate('dashboard')}
              className="w-full h-[60px] flex items-center gap-2 px-4 rounded-lg transition-colors text-white text-sm hover:bg-[#00856f]"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
